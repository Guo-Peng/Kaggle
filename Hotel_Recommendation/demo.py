...
# https://www.kaggle.com/company/expedia-hotel-recommendations/ehr-1/run/236479/code
import datetime
...
def run_solution():
    ...
    while 1:
        ...
        if srch_destination_id != '' and hotel_country != '' and hotel_market != '' and book_year != '':
            best_hotels_search_dest[(srch_destination_id, hotel_country, hotel_market, is_package)][
                hotel_cluster] += append_1
